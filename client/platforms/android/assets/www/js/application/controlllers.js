angular.module('c3po')
    ...
    .controller('groupsCtrl', function ($scope, $rootScope, Client, Groups, ProxyEventsHandler, EventsManager) {
         ...
         */
        ProxyEventsHandler.emitPeriodicGroupUpdate(2000);
    ...
    .controller('groupsAddCtrl', function ($scope, $state, Image, Geolocation, Groups, Client, ProxyEventsHandler) {
        $scope.groupsAddView = {};
        ...
        //TODO Encode default img at app startup
        Image.toBase64("img/utils/nouveau-group-thumbnail.png", function(dataUrl) {
            $scope.groupsAddView.group.thumbnail =dataUrl;
        });
    ...
    .controller('groupCtrl', function ($scope, $rootScope, $stateParams, $filter, Proxy, ProxyEventsHandler, Groups, Client, Tweets, EventsManager) {
        var client = Client.getClient();
    ...
    .controller("mapCtrl", function ($scope, Camera) {
        $scope.takePicture = function () {
            Camera.takeMobilePicture(75);
        }
    });